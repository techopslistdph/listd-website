    ...
    <div className='lg:p-8'>
      ...
      <div className='flex flex-col gap-4 lg:gap-8'>
        {[...Array(3)].map((_, index) => (
          <div
            key={index}
            className='grid grid-cols-1 lg:grid-cols-4 bg-white rounded-2xl lg:rounded-3xl shadow-2xl shadow-[#F7EFFD] p-4 w-full lg:items-stretch relative min-h-[200px]'
          >
            {/* Image skeleton */}
            <div className='flex-shrink-0 flex items-center mb-4 lg:mb-0 col-span-1'>
              <div className='w-full h-48 lg:h-full bg-gray-200 rounded-xl lg:rounded-2xl animate-pulse'></div>
            </div>
