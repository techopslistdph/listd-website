...
export default function UserProfileCard() {
  ...
  const userInitials = getInitials(user.fullName, user.emailAddresses[0]?.emailAddress);
  const displayName = toTitleCase(user.fullName) || user.emailAddresses[0]?.emailAddress;
