...
export default function PropertyTopBar({ onViewChange }: PropertyTopBarProps) {
  ...
  return (
    <div className='flex items-center gap-6 mb-6 w-full text-base'>
      {/* Search Bar */}
      <div className='flex items-center flex-1 bg-[var(--neutral-light)] rounded-full px-6 py-3 text-xl max-w-3xl'>
        <input
          type='text'
          placeholder='Placeholder'
          className='flex-1 bg-transparent outline-none text-[var(--neutral-text)] placeholder:text-[var(--neutral-text)] text-base font-light'
        />
        <svg
